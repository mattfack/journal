...
write_out_i18n_macros('DYI_i18n_ita.tex')
write_out_MonthTbl_macros(cfg.year, 'DYI_Month_Tables_ita.tex')
write_out_MP_macros(cfg.year, 'DYI_Monthly_Planner_Tables_ita.tex')
write_out_WP_macros(cfg.year, 'DYI_Weekly_Planner_Tables_ita.tex')
